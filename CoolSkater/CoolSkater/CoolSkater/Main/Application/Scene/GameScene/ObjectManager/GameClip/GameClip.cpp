...
bool GameClip::Initialize()
{
	...
	m_pEventListener = new GameClipEventListener(this, &GameClip::ReciveEvent);
	SINGLETON_INSTANCE(Lib::EventManager)->AddEventListener(m_pEventListener);

	m_pEvent = new GameClipEvent();
...
void GameClip::ReciveEvent(Lib::EventBase* _pEvent)
{
